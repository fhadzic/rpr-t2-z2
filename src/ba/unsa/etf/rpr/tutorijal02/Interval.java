...
public class Interval {
    ...
    public boolean isNull(){
        if(pocetak == 0 && kraj == 0 && !daLiPripadaPocetak && !daLiPripadaKraj){
            return true;
        }
        return false;
    }
// moje
    public boolean isIn(double v) {
        ...
        if( (v-pocetak > 0.000001 || (v-pocetak == 0 && daLiPripadaPocetak)) && ( kraj-v >0.000001 || (kraj-v == 0 && daLiPripadaKraj) ) ){
            return true;
        }
    ...
    public Interval intersect(Interval interval) {
        Interval result = intersect(this, interval);
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if(pocetak - i2.pocetak < 0.000001 && kraj -i2.kraj < 0.0000001 && daLiPripadaPocetak == i2.daLiPripadaPocetak && daLiPripadaKraj == i2.daLiPripadaKraj){
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return String.format("()", pocetak, kraj);
    }
}
